...
const List<String> kWaterSources = <String>[
  'Canal','BoreWell-2 Inches','BoreWell-3 Inches','BoreWell-4 Inches'
];
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: GoogleMap(
                      ...
                      onTap: (p) => setState(() => _polyPoints.add(p)),
                    ),
                  ),
                ),
                const SizedBox(height: 8),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 6),
                  child: TextFormField(
                    controller: _plantedAreaCtrl,
                    keyboardType: const TextInputType.numberWithOptions(decimal: true),
                    decoration: const InputDecoration(
                      border: OutlineInputBorder(),
                      labelText: 'Planted Area (required)',
                    ),
                    validator: (v) {
                      final t = v?.trim() ?? '';
                      if (t.isEmpty) return 'Required';
