...
class FieldInchargesListScreen extends StatefulWidget {
  final String? uid;

  const FieldInchargesListScreen({Key? key, this.uid}) : super(key: key);

  @override
  State<FieldInchargesListScreen> createState() =>
      _FieldInchargesListScreenState();
}

class _FieldInchargesListScreenState extends State<FieldInchargesListScreen>  {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Field Incharge List Page'),
        leading: IconButton(
