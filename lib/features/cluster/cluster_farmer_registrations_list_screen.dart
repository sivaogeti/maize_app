...
class ClusterFarmerRegistrationsListScreen extends StatelessWidget {
  const ClusterFarmerRegistrationsListScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Farmers Registration Details'),
