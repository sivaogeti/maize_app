...
class ClusterDailyLogsListScreen extends StatefulWidget {
  const ClusterDailyLogsListScreen({super.key});

  @override
  State<ClusterDailyLogsListScreen> createState() =>
      _ClusterDailyLogsListScreenState();
}

class _ClusterDailyLogsListScreenState extends State<ClusterDailyLogsListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Daily Logs — Field Incharge'),
        leading: IconButton(
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ElevatedButton.icon(
                            onPressed: _submitted || _selectedFiId == null
                                ? null
