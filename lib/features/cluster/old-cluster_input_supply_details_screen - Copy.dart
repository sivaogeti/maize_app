...
class ClusterInputSupplyDetailsScreen extends StatefulWidget {
  final String uid;

  const ClusterInputSupplyDetailsScreen({
    Key? key,
    required this.uid,
  }) : super(key: key);

  @override
  State<ClusterInputSupplyDetailsScreen> createState() =>
      _ClusterInputSupplyDetailsScreenState();
}

class _ClusterInputSupplyDetailsScreenState extends State<ClusterInputSupplyDetailsScreen> {
